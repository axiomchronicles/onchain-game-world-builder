...
SECRET_KEY = "aquilify-insecure-QmU115lR7=J$SelO*QHTa*wT#q*vpOucmqUWmz==P0COmB$" # replace with you own strong and secure secret key.
...
DATABASE = {
    "default": {
        "ENGINE": "aquilify.db.axsql.backend.Sqlite3",
